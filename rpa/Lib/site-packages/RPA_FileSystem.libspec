...
<keywordspec name="RPA.FileSystem" type="LIBRARY" format="REST" scope="GLOBAL" generated="2024-08-08T08:51:41+00:00" specversion="5" source="./RPA/FileSystem.py" lineno="70">
<version/>
...
<name>sources</name>
<type name="List" typedoc="list">List[str | Path]<type name="Union" union="true">str | Path<type name="str" typedoc="string">str</type><type name="Path" typedoc="Path">Path</type></type></type>
</arg>
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="destination: str | Path">
<name>destination</name>
<type name="Union" union="true">str | Path<type name="str" typedoc="string">str</type><type name="Path" typedoc="Path">Path</type></type>
