...
<keywordspec name="RPA.MSGraph" type="LIBRARY" format="REST" scope="GLOBAL" generated="2024-08-08T08:51:41+00:00" specversion="5" source="./RPA/MSGraph.py" lineno="61">
<version/>
...
<arguments repr="client_id: str | None = None, client_secret: str | None = None, token: Token | None = None, refresh_token: str | None = None, redirect_uri: str | None = None, vault_backend: bool = False, vault_secret: str | None = None, file_backend_path: Path | None = \temp">
...
<name>token</name>
<type name="Union" union="true">Token | None<type name="Token" typedoc="dictionary">Token</type><type name="None" typedoc="None">None</type></type>
<default>None</default>
</arg>
...
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="file_backend_path: Path | None = \temp">
<name>file_backend_path</name>
<type name="Union" union="true">Path | None<type name="Path" typedoc="Path">Path</type><type name="None" typedoc="None">None</type></type>
<default>\temp</default>
</arg>
</arguments>
...
<keywords>
<kw name="Authorize And Get Token" lineno="462">
...
<kw name="Configure Msgraph Client" lineno="343">
...
<kw name="Create Sharepoint List" lineno="917">
...
<kw name="Download File From Onedrive" lineno="627">
...
<type name="Union" union="true">File | str<type name="File">File</type><type name="str" typedoc="string">str</type></type>
</arg>
...
<name>drive</name>
<type name="Union" union="true">Drive | str | None<type name="Drive">Drive</type><type name="str" typedoc="string">str</type><type name="None" typedoc="None">None</type></type>
<default>None</default>
</arg>
</arguments>
...
<kw name="Download File From Share Link" lineno="755">
...
<kw name="Download File From Sharepoint" lineno="1023">
...
<kw name="Download Folder From Onedrive" lineno="669">
...
<type name="Union" union="true">Folder | str<type name="Folder">Folder</type><type name="str" typedoc="string">str</type></type>
</arg>
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="to_path: str | Path | None = None">
<name>to_path</name>
<type name="Union" union="true">str | Path | None<type name="str" typedoc="string">str</type><type name="Path" typedoc="Path">Path</type><type name="None" typedoc="None">None</type></type>
...
<kw name="Find Onedrive File" lineno="709">
...
<name>target_folder</name>
<type name="Union" union="true">Folder | str | None<type name="Folder">Folder</type><type name="str" typedoc="string">str</type><type name="None" typedoc="None">None</type></type>
<default>None</default>
</arg>
...
<kw name="Generate Oauth Authorization Url" lineno="422">
...
<kw name="Get Drive Instance" lineno="168">
...
<kw name="Get File Instance" lineno="244">
<arguments repr="drive: Drive | str, file: File | str">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="drive: Drive | str">
<name>drive</name>
<type name="Union" union="true">Drive | str<type name="Drive">Drive</type><type name="str" typedoc="string">str</type></type>
</arg>
...
<kw name="Get Folder Instance" lineno="215">
...
<kw name="Get Items From Sharepoint List" lineno="890">
...
<kw name="Get Sharepoint Site" lineno="833">
...
<kw name="List Files In Onedrive Folder" lineno="579">
...
<kw name="List Files In Sharepoint Site Drive" lineno="980">
...
<kw name="List Sharepoint Site Drives" lineno="954">
...
<kw name="Refresh Oauth Token" lineno="487">
...
<kw name="Search For Users" lineno="538">
...
<kw name="Upload File To Onedrive" lineno="798">
