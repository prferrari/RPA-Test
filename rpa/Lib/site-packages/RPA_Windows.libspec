...
<keywordspec name="RPA.Windows" type="LIBRARY" format="REST" scope="GLOBAL" generated="2024-08-08T08:51:43+00:00" specversion="5" source="./RPA/Windows/__init__.py" lineno="24">
<version/>
...
<keywords>
<kw name="Clear Anchor" source="./RPA/Windows/keywords/elements.py" lineno="47">
<arguments repr="">
</arguments>
...
<kw name="Click" source="./RPA/Windows/keywords/action.py" lineno="28">
...
<name>locator</name>
<type name="Union" union="true">WindowsElement | str<type name="WindowsElement">WindowsElement</type><type name="str" typedoc="string">str</type></type>
</arg>
...
<kw name="Close Current Window" source="./RPA/Windows/keywords/window.py" lineno="317">
<arguments repr="">
</arguments>
...
<kw name="Close Window" source="./RPA/Windows/keywords/window.py" lineno="349">
...
<name>locator</name>
<type name="Union" union="true">WindowsElement | str | None<type name="WindowsElement">WindowsElement</type><type name="str" typedoc="string">str</type><type name="None" typedoc="None">None</type></type>
<default>None</default>
</arg>
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="timeout: float | None = None">
<name>timeout</name>
...
<kw name="Disable Process Listing" source="./RPA/Windows/keywords/window.py" lineno="410">
<arguments repr="">
</arguments>
<doc>Disables process iteration in `List Windows` keyword.</doc>
<shortdoc>Disables process iteration in `List Windows` keyword.</shortdoc>
<tags>
<tag>window</tag>
</tags>
</kw>
<kw name="Double Click" source="./RPA/Windows/keywords/action.py" lineno="57">
<arguments repr="locator: WindowsElement | str, wait_time: float | None = None, timeout: float | None = None">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="locator: WindowsElement | str">
<name>locator</name>
<type name="Union" union="true">WindowsElement | str<type name="WindowsElement">WindowsElement</type><type name="str" typedoc="string">str</type></type>
...
<kw name="Drag And Drop" source="./RPA/Windows/keywords/action.py" lineno="668">
...
<kw name="Enable Process Listing" source="./RPA/Windows/keywords/window.py" lineno="405">
<arguments repr="">
</arguments>
<doc>Enables process iteration in `List Windows` keyword.</doc>
<shortdoc>Enables process iteration in `List Windows` keyword.</shortdoc>
<tags>
<tag>window</tag>
</tags>
</kw>
...
<kw name="Get Attribute" source="./RPA/Windows/keywords/elements.py" lineno="126">
...
<type name="Union" union="true">WindowsElement | None<type name="WindowsElement">WindowsElement</type><type name="None" typedoc="None">None</type></type>
<default>None</default>
</arg>
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="timeout: float | None = None">
<name>timeout</name>
...
<kw name="Get Elements" source="./RPA/Windows/keywords/locators.py" lineno="166">
...
<kw name="Get Os Version" source="./RPA/Windows/keywords/window.py" lineno="392">
<arguments repr="">
</arguments>
...
<kw name="Get Text" source="./RPA/Windows/keywords/action.py" lineno="301">
...
<kw name="Get Value" source="./RPA/Windows/keywords/action.py" lineno="334">
<arguments repr="locator: WindowsElement | str">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="locator: WindowsElement | str">
<name>locator</name>
<type name="Union" union="true">WindowsElement | str<type name="WindowsElement">WindowsElement</type><type name="str" typedoc="string">str</type></type>
...
<kw name="List Attributes" source="./RPA/Windows/keywords/elements.py" lineno="153">
<arguments repr="locator: WindowsElement | str">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="locator: WindowsElement | str">
<name>locator</name>
<type name="Union" union="true">WindowsElement | str<type name="WindowsElement">WindowsElement</type><type name="str" typedoc="string">str</type></type>
...
<kw name="Middle Click" source="./RPA/Windows/keywords/action.py" lineno="111">
<arguments repr="locator: WindowsElement | str, wait_time: float | None = None, timeout: float | None = None">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="locator: WindowsElement | str">
<name>locator</name>
<type name="Union" union="true">WindowsElement | str<type name="WindowsElement">WindowsElement</type><type name="str" typedoc="string">str</type></type>
...
<kw name="Print Tree" source="./RPA/Windows/keywords/elements.py" lineno="56">
...
<kw name="Right Click" source="./RPA/Windows/keywords/action.py" lineno="84">
<arguments repr="locator: WindowsElement | str, wait_time: float | None = None, timeout: float | None = None">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="locator: WindowsElement | str">
<name>locator</name>
<type name="Union" union="true">WindowsElement | str<type name="WindowsElement">WindowsElement</type><type name="str" typedoc="string">str</type></type>
...
<kw name="Screenshot" source="./RPA/Windows/keywords/action.py" lineno="593">
<arguments repr="locator: WindowsElement | str, filename: str | Path">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="locator: WindowsElement | str">
<name>locator</name>
<type name="Union" union="true">WindowsElement | str<type name="WindowsElement">WindowsElement</type><type name="str" typedoc="string">str</type></type>
</arg>
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="filename: str | Path">
<name>filename</name>
...
.. code-block:: python
    ...
    def take_screenshots():
        ...
        lib.screenshot("subname:Notepad", "output/notepad.png")</doc>
<shortdoc>Take a screenshot of the element defined by the locator.</shortdoc>
<tags>
<tag>action</tag>
</tags>
</kw>
<kw name="Select" source="./RPA/Windows/keywords/action.py" lineno="203">
...
<doc>Select a value on the passed element if such action is supported.
...
.. code-block:: python
    ...
    def set_notepad_size():
        lib.select("id:FontSizeComboBox", "22")</doc>
<shortdoc>Select a value on the passed element if such action is supported.</shortdoc>
<tags>
<tag>action</tag>
</tags>
</kw>
<kw name="Send Keys" source="./RPA/Windows/keywords/action.py" lineno="249">
...
<kw name="Set Anchor" source="./RPA/Windows/keywords/elements.py" lineno="14">
...
<kw name="Set Focus" source="./RPA/Windows/keywords/action.py" lineno="649">
<arguments repr="locator: WindowsElement | str">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="locator: WindowsElement | str">
<name>locator</name>
<type name="Union" union="true">WindowsElement | str<type name="WindowsElement">WindowsElement</type><type name="str" typedoc="string">str</type></type>
...
<kw name="Set Global Timeout" source="./RPA/Windows/keywords/action.py" lineno="627">
...
<kw name="Set Mouse Movement" source="./RPA/Windows/keywords/action.py" lineno="732">
...
<arguments repr="locator: WindowsElement | str | None = None, value: str | None = None, append: bool = False, enter: bool = False, newline: bool = False, send_keys_fallback: bool = True, validator: Callable | None = &lt;function set_value_validator at 0x000001F9176B98B0&gt;">
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="locator: WindowsElement | str | None = None">
<name>locator</name>
<type name="Union" union="true">WindowsElement | str | None<type name="WindowsElement">WindowsElement</type><type name="str" typedoc="string">str</type><type name="None" typedoc="None">None</type></type>
<default>None</default>
...
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="validator: Callable | None = &lt;function set_value_validator at 0x000001F9176B98B0&gt;">
<name>validator</name>
<type name="Union" union="true">Callable | None<type name="Callable">Callable</type><type name="None" typedoc="None">None</type></type>
<default>&lt;function set_value_validator at 0x000001F9176B98B0&gt;</default>
</arg>
</arguments>
...
<kw name="Set Wait Time" source="./RPA/Windows/keywords/action.py" lineno="567">
...
<doc>Use Windows Run window to launch an application.
...
.. code-block:: python
    ...
    def run_notepad():
        lib.windows_run("notepad")</doc>
<shortdoc>Use Windows Run window to launch an application.</shortdoc>
<tags>
<tag>window</tag>
</tags>
</kw>
<kw name="Windows Search" source="./RPA/Windows/keywords/window.py" lineno="294">
<arguments repr="text: str, wait_time: float = 3.0">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="text: str">
<name>text</name>
<type name="str" typedoc="string">str</type>
