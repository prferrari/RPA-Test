...
<keywordspec name="RPA.HTTP" type="LIBRARY" format="REST" scope="GLOBAL" generated="2024-08-08T08:51:41+00:00" specversion="5" source="./RPA/HTTP.py" lineno="71">
...
<keywords>
<kw name="Check Vulnerabilities" lineno="262">
<arguments repr="">
</arguments>
...
<arguments repr="alias, url, headers={}, cookies={}, client_certs=None, timeout=None, proxies=None, verify=False, debug=0, max_retries=3, backoff_factor=0.1, disable_warnings=0, retry_status_list=[], retry_method_list=['HEAD', 'TRACE', 'DELETE', 'PUT', 'OPTIONS', 'GET']">
...
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="retry_method_list=['HEAD', 'TRACE', 'DELETE', 'PUT', 'OPTIONS', 'GET']">
<name>retry_method_list</name>
<default>['HEAD', 'TRACE', 'DELETE', 'PUT', 'OPTIONS', 'GET']</default>
</arg>
</arguments>
...
<arguments repr="alias, url, auth, headers={}, cookies={}, timeout=None, proxies=None, verify=False, debug=0, max_retries=3, backoff_factor=0.1, disable_warnings=0, retry_status_list=[], retry_method_list=['HEAD', 'TRACE', 'DELETE', 'PUT', 'OPTIONS', 'GET']">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="alias">
<name>alias</name>
</arg>
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="url">
...
<arguments repr="alias, url, headers={}, cookies={}, auth=None, timeout=None, proxies=None, verify=False, debug=0, max_retries=3, backoff_factor=0.1, disable_warnings=0, retry_status_list=[], retry_method_list=['HEAD', 'TRACE', 'DELETE', 'PUT', 'OPTIONS', 'GET']">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="alias">
<name>alias</name>
</arg>
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="url">
...
<kw name="Get Current Session Alias" lineno="181">
<arguments repr="">
</arguments>
...
<kw name="Get File For Streaming Upload" source="./RequestsLibrary/RequestsKeywords.py" lineno="142">
<arguments repr="path">
...
<kw name="Request Should Be Successful" source="./RequestsLibrary/RequestsKeywords.py" lineno="125">
...
<kw name="Status Should Be" source="./RequestsLibrary/RequestsKeywords.py" lineno="77">
