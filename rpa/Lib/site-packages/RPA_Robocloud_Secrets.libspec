...
<keywordspec name="RPA.Robocloud.Secrets" type="LIBRARY" format="REST" scope="GLOBAL" generated="2024-08-08T08:51:42+00:00" specversion="5" source="./RPA/Robocloud/Secrets.py" lineno="14">
<version/>
...
<keywords>
<kw name="Get Secret" source="./RPA/Robocorp/Vault.py" lineno="605">
...
<kw name="Set Secret" source="./RPA/Robocorp/Vault.py" lineno="613">
<arguments repr="secret: Secret">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="secret: Secret">
<name>secret</name>
<type name="Secret" typedoc="dictionary">Secret</type>
</arg>
</arguments>
