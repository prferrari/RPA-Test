...
<keywordspec name="RPA.Calendar" type="LIBRARY" format="REST" scope="GLOBAL" generated="2024-08-08T08:51:39+00:00" specversion="5" source="./RPA/Calendar.py" lineno="24">
<version/>
...
<name>days</name>
<type name="Union" union="true">str | date | DateTime | List[str | date | DateTime]<type name="str" typedoc="string">str</type><type name="date" typedoc="date">date</type><type name="DateTime" typedoc="datetime">DateTime</type><type name="List" typedoc="list">List[str | date | DateTime]<type name="Union" union="true">str | date | DateTime<type name="str" typedoc="string">str</type><type name="date" typedoc="date">date</type><type name="DateTime" typedoc="datetime">DateTime</type></type></type></type>
</arg>
</arguments>
...
<name>time1</name>
<type name="Union" union="true">str | date | DateTime<type name="str" typedoc="string">str</type><type name="date" typedoc="date">date</type><type name="DateTime" typedoc="datetime">DateTime</type></type>
</arg>
...
<name>years</name>
<type name="Union" union="true">int | List[int]<type name="int" typedoc="integer">int</type><type name="List" typedoc="list">List[int]<type name="int" typedoc="integer">int</type></type></type>
</arg>
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="country: str | None = None">
<name>country</name>
<type name="Union" union="true">str | None<type name="str" typedoc="string">str</type><type name="None" typedoc="None">None</type></type>
...
<name>days</name>
<type name="List" typedoc="list">List[int]<type name="int" typedoc="integer">int</type></type>
</arg>
</arguments>
...
<name>dates</name>
<type name="List" typedoc="list">List[str | date | DateTime]<type name="Union" union="true">str | date | DateTime<type name="str" typedoc="string">str</type><type name="date" typedoc="date">date</type><type name="DateTime" typedoc="datetime">DateTime</type></type></type>
</arg>
