...
<keywordspec name="RPA.PDF" type="LIBRARY" format="REST" scope="GLOBAL" generated="2024-08-08T08:51:42+00:00" specversion="5" source="./RPA/PDF/__init__.py" lineno="11">
<version/>
...
<keywords>
<kw name="Add Files To Pdf" source="./RPA/PDF/keywords/document.py" lineno="1204">
...
<kw name="Add Watermark Image To Pdf" source="./RPA/PDF/keywords/document.py" lineno="889">
...
<type name="Union" union="true">str | Path | None<type name="str" typedoc="string">str</type><type name="Path" typedoc="Path">Path</type><type name="None" typedoc="None">None</type></type>
<default>None</default>
</arg>
...
<kw name="Close All Pdfs" source="./RPA/PDF/keywords/document.py" lineno="103">
<arguments repr="">
</arguments>
...
<kw name="Close Pdf" source="./RPA/PDF/keywords/document.py" lineno="121">
...
<kw name="Convert" source="./RPA/PDF/keywords/model.py" lineno="397">
...
<kw name="Decrypt Pdf" source="./RPA/PDF/keywords/document.py" lineno="790">
...
<kw name="Dump Pdf As Xml" source="./RPA/PDF/keywords/model.py" lineno="765">
...
<kw name="Encrypt Pdf" source="./RPA/PDF/keywords/document.py" lineno="725">
...
<kw name="Extract Pages From Pdf" source="./RPA/PDF/keywords/document.py" lineno="597">
<arguments repr="source_path: str | None = None, output_path: str | None = None, pages: int | str | List[int] | List[str] | None = None">
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="source_path: str | None = None">
<name>source_path</name>
<type name="Union" union="true">str | None<type name="str" typedoc="string">str</type><type name="None" typedoc="None">None</type></type>
<default>None</default>
...
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="pages: int | str | List[int] | List[str] | None = None">
<name>pages</name>
<type name="Union" union="true">int | str | List[int] | List[str] | None<type name="int" typedoc="integer">int</type><type name="str" typedoc="string">str</type><type name="List" typedoc="list">List[int]<type name="int" typedoc="integer">int</type></type><type name="List" typedoc="list">List[str]<type name="str" typedoc="string">str</type></type><type name="None" typedoc="None">None</type></type>
<default>None</default>
</arg>
</arguments>
...
<kw name="Find Text" source="./RPA/PDF/keywords/finder.py" lineno="90">
<arguments repr="locator: str, pagenum: int | str = 1, direction: str = right, closest_neighbours: str | int | None = 1, strict: bool = False, regexp: str | None = None, trim: bool = True, ignore_case: bool = False">
...
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="closest_neighbours: str | int | None = 1">
<name>closest_neighbours</name>
<type name="Union" union="true">str | int | None<type name="str" typedoc="string">str</type><type name="int" typedoc="integer">int</type><type name="None" typedoc="None">None</type></type>
<default>1</default>
</arg>
...
<kw name="Get All Figures" source="./RPA/PDF/keywords/document.py" lineno="849">
<arguments repr="source_path: str | None = None">
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="source_path: str | None = None">
<name>source_path</name>
<type name="Union" union="true">str | None<type name="str" typedoc="string">str</type><type name="None" typedoc="None">None</type></type>
...
<kw name="Get Input Fields" source="./RPA/PDF/keywords/model.py" lineno="501">
<arguments repr="source_path: str | None = None, replace_none_value: bool = False, encoding: str | None = iso-8859-1">
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="source_path: str | None = None">
<name>source_path</name>
<type name="Union" union="true">str | None<type name="str" typedoc="string">str</type><type name="None" typedoc="None">None</type></type>
<default>None</default>
...
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="encoding: str | None = iso-8859-1">
<name>encoding</name>
<type name="Union" union="true">str | None<type name="str" typedoc="string">str</type><type name="None" typedoc="None">None</type></type>
...
<kw name="Get Number Of Pages" source="./RPA/PDF/keywords/document.py" lineno="449">
<arguments repr="source_path: str | None = None">
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="source_path: str | None = None">
<name>source_path</name>
<type name="Union" union="true">str | None<type name="str" typedoc="string">str</type><type name="None" typedoc="None">None</type></type>
...
<kw name="Get Pdf Info" source="./RPA/PDF/keywords/document.py" lineno="350">
<arguments repr="source_path: str | None = None">
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="source_path: str | None = None">
<name>source_path</name>
<type name="Union" union="true">str | None<type name="str" typedoc="string">str</type><type name="None" typedoc="None">None</type></type>
...
<kw name="Get Text From Pdf" source="./RPA/PDF/keywords/document.py" lineno="536">
<arguments repr="source_path: str | None = None, pages: int | str | List[int] | List[str] | None = None, details: bool = False, trim: bool = True">
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="source_path: str | None = None">
<name>source_path</name>
<type name="Union" union="true">str | None<type name="str" typedoc="string">str</type><type name="None" typedoc="None">None</type></type>
<default>None</default>
...
<kw name="Html To Pdf" source="./RPA/PDF/keywords/document.py" lineno="273">
<arguments repr="content: str | List[str], output_path: str, encoding: str = utf-8, margin: float = 0, working_directory: str | None = None">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="content: str | List[str]">
<name>content</name>
...
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="margin: float = 0">
<name>margin</name>
<type name="float" typedoc="float">float</type>
<default>0</default>
</arg>
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="working_directory: str | None = None">
...
:param working_directory: directory where to look for HTML linked
 resources, by default uses the current working directory</doc>
<shortdoc>Generate a PDF file from HTML content.</shortdoc>
</kw>
<kw name="Is Pdf Encrypted" source="./RPA/PDF/keywords/document.py" lineno="411">
<arguments repr="source_path: str | None = None">
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="source_path: str | None = None">
<name>source_path</name>
<type name="Union" union="true">str | None<type name="str" typedoc="string">str</type><type name="None" typedoc="None">None</type></type>
...
<kw name="Open Pdf" source="./RPA/PDF/keywords/document.py" lineno="153">
...
<kw name="Rotate Page" source="./RPA/PDF/keywords/document.py" lineno="661">
<arguments repr="pages: int | str | List[int] | List[str] | None, source_path: str | None = None, output_path: str | None = None, clockwise: bool = True, angle: int = 90">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="pages: int | str | List[int] | List[str] | None">
<name>pages</name>
<type name="Union" union="true">int | str | List[int] | List[str] | None<type name="int" typedoc="integer">int</type><type name="str" typedoc="string">str</type><type name="List" typedoc="list">List[int]<type name="int" typedoc="integer">int</type></type><type name="List" typedoc="list">List[str]<type name="str" typedoc="string">str</type></type><type name="None" typedoc="None">None</type></type>
</arg>
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="source_path: str | None = None">
...
<kw name="Save Field Values" source="./RPA/PDF/keywords/model.py" lineno="659">
...
<kw name="Save Figure As Image" source="./RPA/PDF/keywords/document.py" lineno="1068">
...
<kw name="Save Figures As Images" source="./RPA/PDF/keywords/document.py" lineno="1141">
...
<kw name="Save Pdf" source="./RPA/PDF/keywords/document.py" lineno="1003">
<arguments repr="output_path: str, reader: PdfReader | None = None">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="output_path: str">
<name>output_path</name>
<type name="str" typedoc="string">str</type>
</arg>
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="reader: PdfReader | None = None">
<name>reader</name>
<type name="Union" union="true">PdfReader | None<type name="PdfReader">PdfReader</type><type name="None" typedoc="None">None</type></type>
<default>None</default>
</arg>
</arguments>
<doc>Save the contents of a pypdf reader to a new file.
...
:param reader: a pypdf reader (defaults to currently active document)</doc>
<shortdoc>Save the contents of a pypdf reader to a new file.</shortdoc>
</kw>
<kw name="Set Anchor To Element" source="./RPA/PDF/keywords/finder.py" lineno="236">
<arguments repr="locator: str, trim: bool = True, pagenum: int | str = 1, ignore_case: bool = False">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="locator: str">
<name>locator</name>
<type name="str" typedoc="string">str</type>
</arg>
...
<kw name="Set Convert Settings" source="./RPA/PDF/keywords/model.py" lineno="799">
<arguments repr="line_margin: float | None = None, word_margin: float | None = None, char_margin: float | None = None, boxes_flow: float | None = 0.5">
...
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="boxes_flow: float | None = 0.5">
<name>boxes_flow</name>
<type name="Union" union="true">float | None<type name="float" typedoc="float">float</type><type name="None" typedoc="None">None</type></type>
<default>0.5</default>
</arg>
</arguments>
...
<kw name="Set Field Value" source="./RPA/PDF/keywords/model.py" lineno="592">
...
<kw name="Switch To Pdf" source="./RPA/PDF/keywords/document.py" lineno="486">
...
<kw name="Template Html To Pdf" source="./RPA/PDF/keywords/document.py" lineno="199">
<arguments repr="template: str, output_path: str, variables: dict | None = None, encoding: str = utf-8, margin: float = 0, working_directory: str | None = None">
