...
<keywordspec name="RPA.Smartsheet" type="LIBRARY" format="REST" scope="GLOBAL" generated="2024-08-08T08:51:43+00:00" specversion="5" source="./RPA/Smartsheet.py" lineno="74">
<version/>
...
<name>columns</name>
<type name="Union" union="true">List[Dict | Column] | None<type name="List" typedoc="list">List[Dict | Column]<type name="Union" union="true">Dict | Column<type name="Dict" typedoc="dictionary">Dict</type><type name="Column">Column</type></type></type><type name="None" typedoc="None">None</type></type>
<default>None</default>
</arg>
</arguments>
...
<name>sheet</name>
<type name="Union" union="true">Sheet | None<type name="Sheet">Sheet</type><type name="None" typedoc="None">None</type></type>
<default>None</default>
</arg>
</arguments>
...
<type name="Union" union="true">int | str | Dict | Attachment<type name="int" typedoc="integer">int</type><type name="str" typedoc="string">str</type><type name="Dict" typedoc="dictionary">Dict</type><type name="Attachment">Attachment</type></type>
</arg>
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="download_path: Path | str | None = None">
<name>download_path</name>
<type name="Union" union="true">Path | str | None<type name="Path" typedoc="Path">Path</type><type name="str" typedoc="string">str</type><type name="None" typedoc="None">None</type></type>
<default>None</default>
</arg>
</arguments>
...
<name>row</name>
<type name="Union" union="true">int | Row<type name="int" typedoc="integer">int</type><type name="Row">Row</type></type>
</arg>
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="column: int | str | Column">
<name>column</name>
<type name="Union" union="true">int | str | Column<type name="int" typedoc="integer">int</type><type name="str" typedoc="string">str</type><type name="Column">Column</type></type>
</arg>
</arguments>
...
<name>include</name>
<type name="Union" union="true">str | List[Any] | None<type name="str" typedoc="string">str</type><type name="List" typedoc="list">List[Any]<type name="Any" typedoc="Any">Any</type></type><type name="None" typedoc="None">None</type></type>
<default>None</default>
</arg>
...
<name>data</name>
<type name="Union" union="true">Dict | List[Dict] | Row | None<type name="Dict" typedoc="dictionary">Dict</type><type name="List" typedoc="list">List[Dict]<type name="Dict" typedoc="dictionary">Dict</type></type><type name="Row">Row</type><type name="None" typedoc="None">None</type></type>
<default>None</default>
</arg>
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="native: bool = False">
<name>native</name>
