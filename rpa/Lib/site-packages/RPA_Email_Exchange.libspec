...
<keywordspec name="RPA.Email.Exchange" type="LIBRARY" format="REST" scope="GLOBAL" generated="2024-08-08T08:51:40+00:00" specversion="5" source="./RPA/Email/Exchange.py" lineno="121">
<version/>
...
<type name="Union" union="true">AccessType | str<type name="AccessType" typedoc="AccessType">AccessType</type><type name="str" typedoc="string">str</type></type>
...
<kw name="Create Folder" lineno="655">
...
<kw name="Delete Folder" lineno="667">
<arguments repr="folder_name: str, parent_folder: str | None = None">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="folder_name: str">
<name>folder_name</name>
<type name="str" typedoc="string">str</type>
...
<kw name="Delete Message" lineno="1142">
<arguments repr="message: Dict">
...
:param message: dictionary containing message details</doc>
<shortdoc>Delete message.</shortdoc>
</kw>
<kw name="Empty Folder" lineno="699">
...
<kw name="Forward Message" lineno="1131">
<arguments repr="message: Dict, recipients: str | List">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="message: Dict">
<name>message</name>
<type name="Dict" typedoc="dictionary">Dict</type>
</arg>
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="recipients: str | List">
...
:param recipients: email address or list of email addresses</doc>
<shortdoc>Forward message.</shortdoc>
</kw>
...
<kw name="List Messages" lineno="407">
<arguments repr="folder_name: str | None = None, criterion: str | None = None, contains: bool | None = False, count: int | None = 100, save_dir: str | None = None, items_only: bool | None = False">
...
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="items_only: bool | None = False">
<name>items_only</name>
<type name="Union" union="true">bool | None<type name="bool" typedoc="boolean">bool</type><type name="None" typedoc="None">None</type></type>
<default>False</default>
</arg>
</arguments>
...
:param items_only: return only list of Message objects (instead of dictionaries)</doc>
<shortdoc>List messages in the account inbox. Order by descending received time.</shortdoc>
</kw>
<kw name="List Unread Messages" lineno="446">
...
<kw name="Move Message" lineno="754">
...
<kw name="Move Messages" lineno="719">
...
<kw name="Rename Folder" lineno="677">
...
<kw name="Save Attachments" lineno="1037">
...
<name>message</name>
<type name="Union" union="true">dict | str<type name="dict" typedoc="dictionary">dict</type><type name="str" typedoc="string">str</type></type>
</arg>
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="save_dir: str | None = None">
<name>save_dir</name>
<type name="Union" union="true">str | None<type name="str" typedoc="string">str</type><type name="None" typedoc="None">None</type></type>
...
<kw name="Save Message" lineno="1119">
...
<kw name="Send Message" lineno="484">
<arguments repr="recipients: List[str] | str | None = None, subject: str | None = , body: str | None = , attachments: List[str] | str | None = None, html: bool | None = False, images: List[str] | str | None = None, cc: List[str] | str | None = None, bcc: List[str] | str | None = None, save: bool | None = False, reply_to: str | None = None">
...
<kw name="Send Reply Message" lineno="554">
<arguments repr="message: Message | str, body: str, subject: str | None = None, reply_all: bool = False">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="message: Message | str">
<name>message</name>
<type name="Union" union="true">Message | str<type name="Message">Message</type><type name="str" typedoc="string">str</type></type>
</arg>
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="body: str">
<name>body</name>
<type name="str" typedoc="string">str</type>
</arg>
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="subject: str | None = None">
<name>subject</name>
<type name="Union" union="true">str | None<type name="str" typedoc="string">str</type><type name="None" typedoc="None">None</type></type>
<default>None</default>
</arg>
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="reply_all: bool = False">
<name>reply_all</name>
<type name="bool" typedoc="boolean">bool</type>
<default>False</default>
</arg>
</arguments>
<doc>Send reply to a message.
...
.. code-block:: robotframework
    ...
    FOR    ${m}    IN    @{messages}
        ...
        END
    END</doc>
<shortdoc>Send reply to a message.</shortdoc>
</kw>
<kw name="Wait For Message" lineno="905">
...
<usage>Send Reply Message</usage>
