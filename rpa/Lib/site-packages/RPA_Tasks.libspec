...
<keywordspec name="RPA.Tasks" type="LIBRARY" format="REST" scope="GLOBAL" generated="2024-08-08T08:51:43+00:00" specversion="5" source="./RPA/Tasks.py" lineno="334">
<version/>
...
<inits>
<init name="__init__" lineno="623">
<arguments repr="execution_limit=1024, schema=None, graph=True, graph_inline=True">
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="execution_limit=1024">
<name>execution_limit</name>
<default>1024</default>
</arg>
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="schema=None">
<name>schema</name>
<default>None</default>
</arg>
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="graph=True">
<name>graph</name>
<default>True</default>
</arg>
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="graph_inline=True">
<name>graph_inline</name>
<default>True</default>
</arg>
</arguments>
...
:param graph_inline:    Inline graph into log, instead of saving as file</doc>
<shortdoc>There are a few arguments for controlling the Tasks library.</shortdoc>
</init>
</inits>
<keywords>
<kw name="Jump To Task" lineno="826">
<arguments repr="name">
...
teardown sequence.</doc>
<shortdoc>Jump directly to given task, skipping the rest of the task execution. If run inside a teardown, also skips the rest of the teardown sequence.</shortdoc>
</kw>
<kw name="Jump To Task If" lineno="834">
<arguments repr="condition, name, default=None">
...
<doc>Jump directly to given task according to the condition.</doc>
<shortdoc>Jump directly to given task according to the condition.</shortdoc>
</kw>
<kw name="Jump To Task If Keyword Fails" lineno="852">
<arguments repr="task, keyword, *args">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="task">
<name>task</name>
</arg>
...
<doc>Executes given keyword and jumps to given task if it fails.</doc>
<shortdoc>Executes given keyword and jumps to given task if it fails.</shortdoc>
</kw>
<kw name="Jump To Task If Keyword Succeeds" lineno="858">
<arguments repr="task, keyword, *args">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="task">
<name>task</name>
</arg>
...
<doc>Executes given keyword and jumps to given task if it succeeds.</doc>
<shortdoc>Executes given keyword and jumps to given task if it succeeds.</shortdoc>
</kw>
<kw name="Set Next Task" lineno="785">
<arguments repr="name">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="name">
<name>name</name>
</arg>
...
:param name: Name of next task</doc>
<shortdoc>Set the next task to be executed. Should be a task in the same suite.</shortdoc>
</kw>
<kw name="Set Next Task If" lineno="806">
<arguments repr="condition, name, default=None">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="condition">
<name>condition</name>
</arg>
...
:param default:   Name of next task, if unsuccessful</doc>
<shortdoc>Set the next task according to the condition. If no default is given, does not modify execution order.</shortdoc>
</kw>
<kw name="Set Next Task If Keyword Fails" lineno="840">
<arguments repr="task, keyword, *args">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="task">
<name>task</name>
</arg>
...
<doc>Executes given keyword and sets the next task if it fails.</doc>
<shortdoc>Executes given keyword and sets the next task if it fails.</shortdoc>
</kw>
<kw name="Set Next Task If Keyword Succeeds" lineno="846">
<arguments repr="task, keyword, *args">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="task">
<name>task</name>
</arg>
...
<doc>Executes given keyword and sets the next task if it succeeds.</doc>
<shortdoc>Executes given keyword and sets the next task if it succeeds.</shortdoc>
</kw>
</keywords>
<datatypes>
</datatypes>
