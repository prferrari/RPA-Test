...
<keywordspec name="RPA.Robocorp.WorkItems" type="LIBRARY" format="REST" scope="GLOBAL" generated="2024-08-08T08:51:42+00:00" specversion="5" source="./RPA/Robocorp/WorkItems.py" lineno="729">
<version/>
...
<inits>
<init name="__init__" lineno="935">
<arguments repr="autoload: bool = True, root: str | None = None, default_adapter: Type[BaseAdapter] | str = &lt;class 'RPA.Robocorp.WorkItems.RobocorpAdapter'&gt;, auto_parse_email: Dict[str | Tuple[str, ...], str | Tuple[str, ...]] | None = {('email.text', '__mail.html'): ('email.body', 'parsedEmail.Body'), 'rawEmail': 'parsedEmail'}">
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="autoload: bool = True">
<name>autoload</name>
<type name="bool" typedoc="boolean">bool</type>
<default>True</default>
</arg>
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="root: str | None = None">
<name>root</name>
<type name="Union" union="true">str | None<type name="str" typedoc="string">str</type><type name="None" typedoc="None">None</type></type>
<default>None</default>
</arg>
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="default_adapter: Type[BaseAdapter] | str = &lt;class 'RPA.Robocorp.WorkItems.RobocorpAdapter'&gt;">
<name>default_adapter</name>
<type name="Union" union="true">Type[BaseAdapter] | str<type name="Type">Type[BaseAdapter]<type name="BaseAdapter">BaseAdapter</type></type><type name="str" typedoc="string">str</type></type>
<default>&lt;class 'RPA.Robocorp.WorkItems.RobocorpAdapter'&gt;</default>
</arg>
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="auto_parse_email: Dict[str | Tuple[str, ...], str | Tuple[str, ...]] | None = {('email.text', '__mail.html'): ('email.body', 'parsedEmail.Body'), 'rawEmail': 'parsedEmail'}">
<name>auto_parse_email</name>
<type name="Union" union="true">Dict[str | Tuple[str, ...], str | Tuple[str, ...]] | None<type name="Dict" typedoc="dictionary">Dict[str | Tuple[str, ...], str | Tuple[str, ...]]<type name="Union" union="true">str | Tuple[str, ...]<type name="str" typedoc="string">str</type><type name="Tuple" typedoc="tuple">Tuple[str, ...]<type name="str" typedoc="string">str</type><type name="...">...</type></type></type><type name="Union" union="true">str | Tuple[str, ...]<type name="str" typedoc="string">str</type><type name="Tuple" typedoc="tuple">Tuple[str, ...]<type name="str" typedoc="string">str</type><type name="...">...</type></type></type></type><type name="None" typedoc="None">None</type></type>
<default>{('email.text', '__mail.html'): ('email.body', 'parsedEmail.Body'), 'rawEmail': 'parsedEmail'}</default>
</arg>
</arguments>
...
<keywords>
<kw name="Add Work Item File" lineno="1591">
...
<kw name="Add Work Item Files" lineno="1665">
...
<kw name="Clear Work Item" lineno="1302">
<arguments repr="">
</arguments>
...
<kw name="Create Output Work Item" lineno="1204">
<arguments repr="variables: dict | None = None, files: str | List[str] | None = None, save: bool = False">
...
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="files: str | List[str] | None = None">
<name>files</name>
...
<kw name="Delete Work Item Variables" lineno="1509">
...
<kw name="For Each Input Work Item" lineno="1733">
...
<type name="Union" union="true">str | Callable<type name="str" typedoc="string">str</type><type name="Callable">Callable</type></type>
</arg>
...
<kw name="Get Current Work Item" lineno="1945">
<arguments repr="">
</arguments>
...
<kw name="Get Input Work Item" lineno="1174">
...
<kw name="Get Work Item File" lineno="1569">
...
<kw name="Get Work Item Files" lineno="1634">
...
<kw name="Get Work Item Payload" lineno="1327">
<arguments repr="">
</arguments>
...
<kw name="Get Work Item Variable" lineno="1385">
<arguments repr="name, default=&lt;object object at 0x000001F91C21EF30&gt;">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="name">
<name>name</name>
</arg>
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="default=&lt;object object at 0x000001F91C21EF30&gt;">
<name>default</name>
<default>&lt;object object at 0x000001F91C21EF30&gt;</default>
</arg>
</arguments>
...
<kw name="Get Work Item Variables" lineno="1423">
<arguments repr="">
</arguments>
...
<kw name="List Work Item Files" lineno="1554">
<arguments repr="">
</arguments>
...
<kw name="List Work Item Variables" lineno="1369">
<arguments repr="">
</arguments>
...
<kw name="Release Input Work Item" lineno="1825">
<arguments repr="state: State | str, exception_type: Error | str | None = None, code: str | None = None, message: str | None = None, _internal_release: bool = False">
<arg kind="POSITIONAL_OR_NAMED" required="true" repr="state: State | str">
<name>state</name>
<type name="Union" union="true">State | str<type name="State" typedoc="State">State</type><type name="str" typedoc="string">str</type></type>
</arg>
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="exception_type: Error | str | None = None">
<name>exception_type</name>
<type name="Union" union="true">Error | str | None<type name="Error" typedoc="Error">Error</type><type name="str" typedoc="string">str</type><type name="None" typedoc="None">None</type></type>
<default>None</default>
</arg>
...
<arg kind="POSITIONAL_OR_NAMED" required="false" repr="_internal_release: bool = False">
<name>_internal_release</name>
<type name="bool" typedoc="boolean">bool</type>
<default>False</default>
</arg>
</arguments>
...
<kw name="Remove Work Item File" lineno="1613">
...
<kw name="Remove Work Item Files" lineno="1690">
...
<kw name="Save Work Item" lineno="1295">
<arguments repr="">
</arguments>
...
<kw name="Set Task Variables From Work Item" lineno="1533">
<arguments repr="">
</arguments>
...
<kw name="Set Work Item Payload" lineno="1344">
...
<kw name="Set Work Item Variable" lineno="1458">
...
<kw name="Set Work Item Variables" lineno="1489">
